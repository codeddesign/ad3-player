package
{
	...
	public class VPAIDFlash extends Sprite
	{
		...
		private function objectToArray(obj:Object):Array {
		...
		private function addVPAIDInterface():void {
			...
			//special callbacks
			ExternalInterface.addCallback('loadAdUnit', function (message:Object):void {
				message = objectToArray(message);

				loadAdUnit.apply(this, message);
			});
			ExternalInterface.addCallback('unloadAdUnit', function (message:Object):void {
				message = objectToArray(message);
			...
			callbacks.forEach(function (item:*, index:int, arr:Array):void {
				...
				ExternalInterface.addCallback(item.event, function (message:Object):void {
					message = objectToArray(message);
